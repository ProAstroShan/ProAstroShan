...
## About me
I am ProAstroShan, also known by my real name: Roshan Kumar. I am a student who has a passion for programming and likes to explore building code for things like data analysis, fundamentals of machine learning, and algorithmic problem solving, using Python. I also have a large interest in STEM. I am not an expert in programming yet, but I am always trying to improve.

## What I am focusing on
Currently, I am focusing on using mostly Python to create text-based games and simulations, simple machine learning algorithms like KNN, and data analysis with visualisations. I also use these skills to find patterns in data and construct potential relationships during data analysis.
